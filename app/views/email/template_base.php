...
<head>
    ...
    <style>
        ...
        .email-bg { background-color: #F9F9F9 !important; font-family: 'Poppins', Arial, sans-serif; }
        .email-container { background-color: #FEF8FB !important; color: #2C2C2C !important; }
        .text-main { color: #2C2C2C !important; font-family: 'Poppins', Arial, sans-serif; }
        .text-muted { color: #9E9E9E !important; font-family: 'Poppins', Arial, sans-serif; }
        .text-footer { color: #A0AEC0 !important; font-family: 'Poppins', Arial, sans-serif; }
        .code-box { background-color: #FBDBEB !important; border: 2px dashed #FA5672 !important; }
        .code-text { color: #FA5672 !important; font-family: 'Poppins', Arial, sans-serif; }
        .header-bg { background-color: #4F4873 !important; }
        .footer-bg { background-color: #2D2444 !important; }
        .btn-link { background-color: #FA5672 !important; color: #FFFFFF !important; padding: 14px 28px; text-decoration: none; border-radius: 8px; font-weight: bold; display: inline-block; font-family: 'Poppins', Arial, sans-serif; }
        .title-font { font-family: 'Shantell Sans', cursive, Arial !important; }

        /* Modo Escuro Automático */
        @media (prefers-color-scheme: dark) {
            .email-bg { background-color: #0C0B28 !important; }
            .email-container { background-color: #150D37 !important; color: #FFFFFF !important; }
            .text-main { color: #FFFFFF !important; }
            .text-muted { color: #CDB3C0 !important; }
            .text-footer { color: #9E9E9E !important; }
            .code-box { background-color: #2E282B !important; border: 2px dashed #FA5672 !important; }
            .code-text { color: #FA5672 !important; }
            .header-bg { background-color: #111042 !important; }
            .footer-bg { background-color: #171415 !important; }
        }
    </style>
</head>
