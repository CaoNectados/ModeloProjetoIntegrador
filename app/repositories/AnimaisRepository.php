...
{
    public function cadastrarAnimal(Animais $animal): int
    {
    ...
    public function buscarPorId(int $id): ?Animais
    {
        $sql = "SELECT
            animal_id,
            protetor_id,
    ...
    public function listarAnimais(): array
    {
        $sql = "SELECT
            animal_id,
            protetor_id,
        ...
        return array_map(function (array $row): Animais {
            return $this->mapAnimal($row);
        }, $rows);
    }

    public function editarAnimal(Animais $animal): bool
    {
    ...
    {
        $sql = "UPDATE ANIMAIS SET status = :status, atualizado_em = CURRENT_TIMESTAMP WHERE animal_id = :animal_id";
    ...
    {
        $sql = "UPDATE ANIMAIS SET deletado_em = CURRENT_TIMESTAMP, atualizado_em = CURRENT_TIMESTAMP WHERE animal_id = :animal_id AND deletado_em IS NULL";
    ...
    {
        $sql = "UPDATE ANIMAIS SET deletado_em = NULL, atualizado_em = CURRENT_TIMESTAMP WHERE animal_id = :animal_id";
    ...
    {
        $sql = "SELECT 1 FROM ANIMAIS WHERE animal_id = :animal_id LIMIT 1";
    ...
    {
        $sql = "SELECT deletado_em FROM ANIMAIS WHERE animal_id = :animal_id";
    ...
    public function salvar(Animais $animal): int
    {
    ...
    {
        return $this->listarAnimais();
    }

    public function atualizar(Animais $animal): bool
    {
    ...
    private function bindAnimalValues(PDOStatement $stmt, Animais $animal): void
    {
    ...
    private function mapAnimal(array $row): Animais
    {
        $animal = new Animais();
